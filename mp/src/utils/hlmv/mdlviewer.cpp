...
: mxWindow (0, 0, 0, 0, 0, g_appTitle, mxWindow::Normal)
{
	...
	menuHelp->add ("The secret text...", IDC_HELP_GOTOHOMEPAGE);
...
MDLViewer::handleEvent (mxEvent *event)
{
	...
	case mxEvent::Action:
	{
		...
		case IDC_HELP_GOTOHOMEPAGE:
			...
			mxMessageBox(this, "4490745", "", MX_MB_INFORMATION);
			break;
#endif
		...
		case IDC_HELP_ABOUT:
			...
			mxMessageBox (this,
				" ===== ORIGINAL COPYRIGHT HEADER THING =====\n"
				"Half-Life Model Viewer v2.0 (c) 2004 Valve Corp.\n"
				"Portions (c) 1999 by Mete Ciragan\n"
				"  ==== ORIGINAL COPYRIGHT HEADER END =====\n\n"
				"Spectruminary model viewer, 2020 leak backport\n"
				"by yours truly (Almix-o)\n\n"
				"Build:\t" __DATE__ ".\n"
				"Special Thanks to Dermoker for the app icon.\n"
				"...you probably know how to use this.\n", "About Spectruminary Model Viewer",
				MX_MB_OK | MX_MB_INFORMATION);
			break;
