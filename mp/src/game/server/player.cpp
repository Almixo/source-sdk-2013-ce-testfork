...
#if !defined( CSTRIKE_DLL ) && !defined( HL1_DLL )
...
ConVar cl_sidespeed( "cl_sidespeed", "320", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar cl_upspeed( "cl_upspeed", "320", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar cl_forwardspeed( "cl_forwardspeed", "320", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar cl_backspeed( "cl_backspeed", "320", FCVAR_REPLICATED | FCVAR_CHEAT );
#endif // CSTRIKE_DLL
